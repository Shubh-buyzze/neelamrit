          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="flex-1 p-8 sm:p-12 lg:p-14">
              ...
              <div className="md:hidden flex items-center gap-4 mb-6 opacity-40">
                <div className="flex-1 h-px bg-gray-400"></div><span className="text-[10px] font-black uppercase tracking-widest text-gray-600">OR EMAIL</span><div className="flex-1 h-px bg-gray-400"></div>
              </div>
