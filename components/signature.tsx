    ...
    <PageBackground>
      ...
      <div className="pt-20 md:pt-24 pb-4 px-4 sm:px-6 max-w-6xl mx-auto">
        <div className="flex items-center gap-2 text-xs font-medium text-gray-500 mb-6">
          ...
          <span>/</span><span className="text-gray-900">Signature Box</span>
        </div>
        ...
        <section className="relative z-10 pb-24 md:pb-16">
          <div className="flex flex-col md:flex-row gap-8 lg:gap-16 items-start">
            ...
            <div className="w-full md:w-1/2 flex-shrink-0 flex flex-col items-center">
              ...
              >
                {activeMedia.type === 'video' ? (
                  ...
                  <Image src={activeMedia.url} alt="Signature Box" fill className="object-contain drop-shadow-2xl scale-95 p-6 md:p-8 select-none" draggable={false} priority />
                )}
              </div>
            ...
            <div className="w-full md:w-1/2 flex flex-col pt-2 mt-4 md:mt-0">
              <span className="text-[10px] font-black text-amber-800 uppercase tracking-widest mb-2">Gifting Pack</span>
              <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-2 leading-tight">Signature Box</h1>
              <p className="text-gray-500 text-sm font-medium mb-6">500g • 16 Pieces</p>
              ...
              <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-8">
                Our heritage recipe in a beautiful hexagonal box. Ideal for gifting and celebrations. 
                Made with pure desi ghee, premium dry fruits, and traditional recipes.
              </p>

              <div className="mb-8">
                <h3 className="text-xs font-bold text-gray-900 uppercase tracking-widest mb-4">Key Features</h3>
                <ul className="space-y-3">
                  {["100% Pure Jaggery", "Zero Refined Sugar", "Premium Quality Ingredients", "Luxury Gift Packaging"].map((point, idx) => (
              ...
              <div className="hidden md:block border-t border-gray-100 pt-8 mt-4">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex-1">
                    <AddToCartBtn productId="prod_signature_box" quantity={quantity} />
                  </div>
                </div>
              </div>
            </div>
